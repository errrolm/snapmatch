        ...
        {showLoseModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80">
            <div className="w-full max-w-md p-6 rounded-xl bg-neutral-900 border border-neutral-800">
              ...
              <div className="flex gap-3 justify-center">
                <Button onClick={() => { setShowLoseModal(false); restart(); }} className="bg-emerald-600 hover:bg-emerald-500 text-white px-5 py-2 rounded-lg cursor-pointer">
                  Try again
                </Button>
                <Button onClick={() => { setShowLoseModal(false); setShowLevelModal(true); }} className="bg-transparent border border-neutral-700 hover:bg-neutral-800 text-white px-4 py-2 rounded-lg cursor-pointer">
                  Change level
                </Button>
              </div>
            </div>
